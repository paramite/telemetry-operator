...
func (in *CeilometerStatus) DeepCopyInto(out *CeilometerStatus) {
	*out = *in
	in.CeilometerStatusCore.DeepCopyInto(&out.CeilometerStatusCore)
	if in.Networks != nil {
		in, out := &in.Networks, &out.Networks
		*out = make([]string, len(*in))
		copy(*out, *in)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CeilometerStatusCore) DeepCopyInto(out *CeilometerStatusCore) {
	*out = *in
	if in.Hash != nil {
		in, out := &in.Hash, &out.Hash
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CeilometerStatusCore.
func (in *CeilometerStatusCore) DeepCopy() *CeilometerStatusCore {
	if in == nil {
		return nil
	}
	out := new(CeilometerStatusCore)
	in.DeepCopyInto(out)
	return out
}
